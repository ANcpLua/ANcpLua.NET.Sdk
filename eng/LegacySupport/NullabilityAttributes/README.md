# Nullability Attributes Polyfills

This directory contains polyfills for various C# nullability-related attributes.

## Usage

To inject these nullability attribute polyfills into your project, set the following property in your `.csproj` file:
...
<details> <summary><code>NullableAttributes.cs</code> (injected)</summary>
